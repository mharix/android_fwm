...
public class FoodDessert extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_food_dessert, container, false);
        ...
        fetchDetails();
        LinearLayout clickButton = (LinearLayout) root.findViewById(R.id.nextToDrink);
    ...
    private void gotodrink( ) {
        ...
        FoodDrinks fragment= new FoodDrinks();
