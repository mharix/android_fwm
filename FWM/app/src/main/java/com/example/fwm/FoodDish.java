...
public class FoodDish extends Fragment {
...
View root=inflater.inflate(R.layout.fragment_food_dish, container, false);
  ...
  fetchDetails();
        LinearLayout clickButton = (LinearLayout) root.findViewById(R.id.nextToDessert);
        ...
        storeToDb.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Log.e("inside next","0");
//here we disable all check check box to stop double entry in db
